...
- `gen_train_val_test_data`: Contains the scripts to generate the training, validation, and test data for the example. In this example, 1,000 simulation cases are generated.
