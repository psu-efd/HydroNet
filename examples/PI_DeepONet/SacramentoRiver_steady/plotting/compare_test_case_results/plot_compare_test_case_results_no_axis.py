...
def plot_compare_test_case_results(test_case_indices, deeponet_result_dir, pi_deeponet_result_dir):
    ...
    for test_case_index in test_case_indices:
        ...
        if triangles is not None:
            ...
            cbar.ax.text(0.5, 1.05, '(m)', fontsize=24, transform=cbar.ax.transAxes, horizontalalignment='center', verticalalignment='bottom')
            #axs1[0, 0].text(-0.15, 1.1, '(a)', fontsize=32, fontweight='bold', transform=axs1[0, 0].transAxes, horizontalalignment='left', verticalalignment='top')
            ...
            #axs1[0, 1].text(-0.15, 1.1, '(b)', fontsize=32, fontweight='bold', transform=axs1[0, 1].transAxes, horizontalalignment='left', verticalalignment='top')
            ...
            cbar.ax.tick_params(labelsize=24)
            cbar.ax.text(0.5, 1.05, '(m/s)', fontsize=24, transform=cbar.ax.transAxes, horizontalalignment='center', verticalalignment='bottom')
            #axs1[0, 2].text(-0.15, 1.1, '(c)', fontsize=32, fontweight='bold', transform=axs1[0, 2].transAxes, horizontalalignment='left', verticalalignment='top')
            
            # Velocity vector (quiver plot on contour of magnitude)
            vel_mag_sim = np.sqrt(sim_u_pt**2 + sim_v_pt**2)
            cf = axs1[0, 3].tricontourf(points[:, 0], points[:, 1], triangles, vel_mag_sim, levels=20, cmap=plt.cm.RdBu_r)
            # Subsample for quiver
            #step = max(1, len(points) // 500)
            step = 2
            axs1[0, 3].quiver(points[::step, 0], points[::step, 1], 
            ...
            cbar.ax.tick_params(labelsize=24)
            cbar.ax.text(0.5, 1.05, '(m/s)', fontsize=24, transform=cbar.ax.transAxes, horizontalalignment='center', verticalalignment='bottom')
            #axs1[0, 3].text(-0.15, 1.1, '(d)', fontsize=32, fontweight='bold', transform=axs1[0, 3].transAxes, horizontalalignment='left', verticalalignment='top')
        ...
        if triangles is not None:
            ...
            cbar.ax.tick_params(labelsize=24)
            cbar.ax.text(0.5, 1.05, '(m)', fontsize=24, transform=cbar.ax.transAxes, horizontalalignment='center', verticalalignment='bottom')
            #axs1[1, 0].text(-0.15, 1.1, '(e)', fontsize=32, fontweight='bold', transform=axs1[1, 0].transAxes, horizontalalignment='left', verticalalignment='top')
            ...
            cbar.ax.tick_params(labelsize=24)
            cbar.ax.text(0.5, 1.05, '(m/s)', fontsize=24, transform=cbar.ax.transAxes, horizontalalignment='center', verticalalignment='bottom')
            #axs1[1, 1].text(-0.15, 1.1, '(f)', fontsize=32, fontweight='bold', transform=axs1[1, 1].transAxes, horizontalalignment='left', verticalalignment='top')
            ...
            cbar.ax.tick_params(labelsize=24)
            cbar.ax.text(0.5, 1.05, '(m/s)', fontsize=24, transform=cbar.ax.transAxes, horizontalalignment='center', verticalalignment='bottom')
            #axs1[1, 2].text(-0.15, 1.1, '(g)', fontsize=32, fontweight='bold', transform=axs1[1, 2].transAxes, horizontalalignment='left', verticalalignment='top')
            
            # Velocity vector
            vel_mag_deeponet = np.sqrt(deeponet_u_pt**2 + deeponet_v_pt**2)
            cf = axs1[1, 3].tricontourf(points[:, 0], points[:, 1], triangles, vel_mag_deeponet, levels=20, cmap=plt.cm.RdBu_r)
            axs1[1, 3].quiver(points[::step, 0], points[::step, 1], 
            ...
            cbar.ax.tick_params(labelsize=24)
            cbar.ax.text(0.5, 1.05, '(m/s)', fontsize=24, transform=cbar.ax.transAxes, horizontalalignment='center', verticalalignment='bottom')
            #axs1[1, 3].text(-0.15, 1.1, '(h)', fontsize=32, fontweight='bold', transform=axs1[1, 3].transAxes, horizontalalignment='left', verticalalignment='top')
        ...
        if triangles is not None:
            ...
            cbar.ax.tick_params(labelsize=24)
            cbar.ax.text(0.5, 1.05, '(m)', fontsize=24, transform=cbar.ax.transAxes, horizontalalignment='center', verticalalignment='bottom')
            #axs1[2, 0].text(-0.15, 1.1, '(i)', fontsize=32, fontweight='bold', transform=axs1[2, 0].transAxes, horizontalalignment='left', verticalalignment='top')
            ...
            cbar.ax.tick_params(labelsize=24)
            cbar.ax.text(0.5, 1.05, '(m/s)', fontsize=24, transform=cbar.ax.transAxes, horizontalalignment='center', verticalalignment='bottom')
            #axs1[2, 1].text(-0.15, 1.1, '(j)', fontsize=32, fontweight='bold', transform=axs1[2, 1].transAxes, horizontalalignment='left', verticalalignment='top')
            ...
            cbar.ax.tick_params(labelsize=24)
            cbar.ax.text(0.5, 1.05, '(m/s)', fontsize=24, transform=cbar.ax.transAxes, horizontalalignment='center', verticalalignment='bottom')
            #axs1[2, 2].text(-0.15, 1.1, '(k)', fontsize=32, fontweight='bold', transform=axs1[2, 2].transAxes, horizontalalignment='left', verticalalignment='top')
            
            # Velocity vector
            vel_mag_pi = np.sqrt(pi_u_pt**2 + pi_v_pt**2)
            cf = axs1[2, 3].tricontourf(points[:, 0], points[:, 1], triangles, vel_mag_pi, levels=20, cmap=plt.cm.RdBu_r)
            axs1[2, 3].quiver(points[::step, 0], points[::step, 1], 
            ...
            cbar.ax.tick_params(labelsize=24)
            cbar.ax.text(0.5, 1.05, '(m/s)', fontsize=24, transform=cbar.ax.transAxes, horizontalalignment='center', verticalalignment='bottom')
            #axs1[2, 3].text(-0.15, 1.1, '(l)', fontsize=32, fontweight='bold', transform=axs1[2, 3].transAxes, horizontalalignment='left', verticalalignment='top')
        ...
        if triangles is not None:
            ...
            #axs2[0, 0].text(-0.15, 1.1, '(a)', fontsize=22, fontweight='bold', transform=axs2[0, 0].transAxes, horizontalalignment='left', verticalalignment='top')
            ...
            #axs2[0, 1].text(-0.15, 1.1, '(b)', fontsize=22, fontweight='bold', transform=axs2[0, 1].transAxes, horizontalalignment='left', verticalalignment='top')
            ...
            #axs2[0, 2].text(-0.15, 1.1, '(c)', fontsize=22, fontweight='bold', transform=axs2[0, 2].transAxes, horizontalalignment='left', verticalalignment='top')

            # Velocity magnitude difference
            vmax = diff_deeponet_vel_mag_pt.max()
            vmin = diff_deeponet_vel_mag_pt.min()

            #compute RMSE
            rmse_vel_mag = np.sqrt(np.mean(diff_deeponet_vel_mag_pt**2))
            ...
            #axs2[0, 3].text(-0.15, 1.1, '(d)', fontsize=22, fontweight='bold', transform=axs2[0, 3].transAxes, horizontalalignment='left', verticalalignment='top')
        ...
        if triangles is not None:
            ...
            #axs2[1, 0].text(-0.15, 1.1, '(e)', fontsize=22, fontweight='bold', transform=axs2[1, 0].transAxes, horizontalalignment='left', verticalalignment='top')
            ...
            #axs2[1, 1].text(-0.15, 1.1, '(f)', fontsize=22, fontweight='bold', transform=axs2[1, 1].transAxes, horizontalalignment='left', verticalalignment='top')
            ...
            #axs2[1, 2].text(-0.15, 1.1, '(g)', fontsize=22, fontweight='bold', transform=axs2[1, 2].transAxes, horizontalalignment='left', verticalalignment='top')
            
            # Velocity magnitude difference
            vmax = diff_pi_vel_mag_pt.max()
            vmin = diff_pi_vel_mag_pt.min()

            #compute RMSE
            rmse_vel_mag = np.sqrt(np.mean(diff_pi_vel_mag_pt**2))
            ...
            #axs2[1, 3].text(-0.15, 1.1, '(h)', fontsize=22, fontweight='bold', transform=axs2[1, 3].transAxes, horizontalalignment='left', verticalalignment='top')
        
        plt.tight_layout()
        #adjust the column spacing
