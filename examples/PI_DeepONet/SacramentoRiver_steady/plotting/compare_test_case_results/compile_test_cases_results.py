...
if __name__ == "__main__":
    ...
    pi_deeponet_results = json.load(open(pi_deeponet_result_file))

    print("deeponet_results: ", deeponet_results)
    print("pi_deeponet_results: ", pi_deeponet_results)
    ...
    pi_deeponet_total_loss = pi_deeponet_results['test_loss_rmse']
    pi_deeponet_norm_h = pi_deeponet_results['normalized']['rmse_per_dim'][0]
    pi_deeponet_norm_u = pi_deeponet_results['normalized']['rmse_per_dim'][1]
    pi_deeponet_norm_v = pi_deeponet_results['normalized']['rmse_per_dim'][2]
    pi_deeponet_denorm_h = pi_deeponet_results['denormalized']['rmse_per_dim'][0]
    pi_deeponet_denorm_u = pi_deeponet_results['denormalized']['rmse_per_dim'][1]
    pi_deeponet_denorm_v = pi_deeponet_results['denormalized']['rmse_per_dim'][2]
    ...
    \\begin{tabular}{lccccccc}
        ...
        PI-SWE-DeepONet & """ + format_num(pi_deeponet_total_loss, 3) + """ & """ + \
        format_num(pi_deeponet_norm_h, 3) + """ & """ + format_num(pi_deeponet_norm_u, 3) + """ & """ + format_num(pi_deeponet_norm_v, 3) + """ & """ + \
        format_num(pi_deeponet_denorm_h, 3) + """ & """ + format_num(pi_deeponet_denorm_u, 3) + """ & """ + format_num(pi_deeponet_denorm_v, 3) + """ \\\\
        \\bottomrule
    \\end{tabular}
\\end{table}"""
