...
# Get the project root directory (assumes this script is in examples/PINN/oneD_channel_steady/case_preparation directory)
script_path = os.path.abspath(__file__)
script_dir = os.path.dirname(script_path)  # case_preparation directory
steady_dir = os.path.dirname(script_dir)  # oneD_channel_steady directory
...
if __name__ == '__main__':
    ...
    srhcontrol_file = os.path.join(current_dir, "oneD_channel_with_bump.srhhydro")   #oneD_channel_with_bump.srhhydro is the SRH-2D case file for the oneD_channel_with_bump example
    ...
    srh_to_pinn_points(srhcontrol_file, refinement_pde=1, refinement_bc=1)
    ...
    result_file = "oneD_channel_with_bump_XMDFC.h5"   #Name of the SRH-2D result file (currently only XMDFC format is supported)
