...
def gmsh2d_to_3d(gmsh2d_fileName, gmsh3d_fileName):
    ...
    mesh.write("check_mesh_before.vtk", file_format="vtk42")
    ...
    #    mesh.points[i,2] = max(0.0, 0.1 - 0.05*(x-10.0)**2.0) + 0.0001*(x_max-x)

    #output the 3D mesh as vtk for checking
    mesh.write("check_mesh_after.vtk", file_format="vtk42")
...
if __name__ == "__main__":
    ...
    gmsh3d_fileName = "block_in_channel_3d.msh"
